...
#this py file let user to set parameter themselves while running
#eg:python parser.py --camera 2 --show_fps True --show_proc_time True --ear_thresh 0.15 --gaze_thresh 0.015 --camera_params "/config/camera_params.yaml"

#if dk what para available:
