...
class HeadPoseEstimator:
    ...
    #estimate head pose (use SolvePnp)
    def get_pose(self, frame, landmarks, frame_size):
        ...
        """
        #rotation vector: rvec, translation vector: rvec
        rvec = None
        tvec = None
        model_img_lms = None
        eulers = None
        ...
        #use cv2.solvePnP to compute rotation & translation vectors
        ...
        if solve_pnp_success:
            ...
            #convert rvec to Euler angles (yaw, pitch, roll)
    ...
    #draw the head's orientation axes
